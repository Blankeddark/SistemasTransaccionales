 ...
 */
public class ServletConsultarClienteGeneral extends ASParsingServlet {

	ArrayList rtaClientes;
	
	public ServletConsultarClienteGeneral()
	{
	...
	private void imprimirConsultarClienteGeneralInicial(PrintWriter pw)
	{
		...
		pw.println("<div class=\"row\">");
		pw.println("<div class=\"col-lg-12\">");
		pw.println("<form role=\"form\" method=\"post\" action=\"consultarClienteGeneral\">");
