...
public class ServletRegistrarCliente extends ASServlet {
	...
	/**
	 * Registra el cliente cuyos datos fueron ingresados por parámetro.
	 */
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		System.out.println(correo); //TODO terminar método de inserción de cliente.
	}
	...
	private void imprimirRegistrarClienteInicial(PrintWriter pw)
	{
		...
		pw.println("<input class=\"form-control\" name=\"contraseña\">");
		pw.println("</div>");
		pw.println("<div class=\"form-group\">");
