 ...
 */
public class ServletConsultarCuentaOficina extends ASServlet {

	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		System.out.println("en doGet de ServletConsultarCuentas");

		PrintWriter pw = response.getWriter();
		imprimirEncabezado(pw);
		imprimirSidebarGO(pw);
		imprimirConsultarCuentaOficinaInicial(pw);
		imprimirWrapper(pw);
	}

	private void imprimirConsultarCuentaOficinaInicial(PrintWriter pw)
	{
