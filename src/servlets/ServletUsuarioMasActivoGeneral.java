...
/**
 * url-pattern /usuarioMasActivoGeneral
 */
public class ServletUsuarioMasActivoGeneral extends ASServlet {

	 ArrayList<UsuarioActivoValues> usuariosMasActivos;
	 
	 public ServletUsuarioMasActivoGeneral()
	 {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		usuariosMasActivos = BancAndes.darInstancia().darUsuarioActivoGeneral(tipoTransaccion);
