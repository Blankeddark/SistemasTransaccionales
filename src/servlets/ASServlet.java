...
public abstract class ASServlet extends HttpServlet {
	...
	/**
	 * Imprime todo el HTML hasta el sidebar común para todas las páginas en el sidebar del 
	 * Gerente Oficina
	 * @param pw PrintWriter del response en el que se escribirá el sidebar común.
	 */
