 ...
 */
public class ServletConsultarPrestamosGeneral extends ASParsingServlet {

	ArrayList<PrestamoValues> prestamos;
	
	public ServletConsultarPrestamosGeneral()
	{
	...
	{
		System.out.println("en doGet de ServletConsultarPrestamoGeneral");
	...
	{
		System.out.println("en doPost de ServletConsultarPrestamoGeneral");
		PrintWriter pw = response.getWriter();
		...
		prestamos = BancAndes.darInstancia().darPrestamosGeneral(ordenarPor, 
				tipoPrestamo, descoasc);
	...
	private void imprimirConsultarPrestamoGeneralInicial(PrintWriter pw)
	{
		...
		pw.println("<div class=\"row\">");
		pw.println("<div class=\"col-lg-12\">");
		pw.println("<form role=\"form\" action=\"consultarPrestamosGeneral\" method=\"post\">");
