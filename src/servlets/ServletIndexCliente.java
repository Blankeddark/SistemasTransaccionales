 ...
 * url-pattern: /cliente
 */
public class ServletIndexCliente extends ASServlet {

	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		System.out.println("doGet en ServletIndexCliente");

		PrintWriter pw = response.getWriter();

		imprimirEncabezado(pw);
		imprimirSidebarCliente(pw);
		imprimirIndexClienteInicial(pw);
		imprimirWrapper(pw);
	}

	private void imprimirIndexClienteInicial(PrintWriter pw)
	{
		pw.println("<div id=\"page-wrapper\">");
		pw.println("<div class=\"row\">");
		pw.println("<div class=\"col-lg-12\">");
		pw.println("<h1 class=\"page-header\">Men&uacute; de cliente</h1>");
		pw.println("</div>");
